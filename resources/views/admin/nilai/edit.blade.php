...
@section('subheading', 'Perbarui catatan nilai.')

@section('content')
    <form method="POST" action="{{ route('admin.nilai.update', $nilai) }}" class="soft-panel max-w-2xl space-y-5 p-5 sm:p-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex flex-wrap gap-3 pt-2">
            ...
            <x-button variant="secondary" href="{{ route('admin.nilai.index') }}" type="button">Batal</x-button>
        </div>
    </form>
@endsection
