...
@section('title', 'Kontak & Akses Kampus (交通アクセス) — SMK Shuka (秀華高等専門学校)')
@section('page_header', true)
@section('page_heading', 'Kontak & Akses Kampus (交通アクセス・お問い合わせ)')
@section('page_subheading_jp', '秀華高等専門学校 • 所在地・交通案内・窓口案内')
        ...
        <div class="md:col-span-8 space-y-6">
            ...
            <section class="bg-white border border-slate-200 rounded-lg p-6 shadow-sm space-y-4">
                <div class="flex items-center gap-2 pb-3 border-b border-slate-200">
                    ...
                    <h2 class="text-base sm:text-lg font-bold text-slate-900">Alamat & Lokasi Kampus (所在地)</h2>
                </div>
            ...
            <section class="bg-white border border-slate-200 rounded-lg p-6 shadow-sm space-y-4">
                <div class="flex items-center gap-2 pb-3 border-b border-slate-200">
                    ...
                    <h2 class="text-base sm:text-lg font-bold text-slate-900">Akses Transportasi Kereta (電車でのアクセス)</h2>
                </div>

                <div class="space-y-3 text-xs text-slate-600 leading-relaxed">
                    <div class="p-3 bg-slate-50 border border-slate-200 rounded space-y-1">
                        <span class="font-bold text-slate-900 text-xs">Jalur Odakyu Odawara (小田急小田原線)</span>
                        <p>Turun di <strong>Stasiun Shimokitazawa (下北沢駅)</strong>, keluar melalui Gerbang Timur (東口), berjalan kaki sekitar 4 menit menuju area Livehouse STARRY & Kampus SMK Shuka.</p>
                    </div>

                    <div class="p-3 bg-slate-50 border border-slate-200 rounded space-y-1">
                        <span class="font-bold text-slate-900 text-xs">Jalur Keio Inokashira (京王井の頭線)</span>
                        <p>Turun di <strong>Stasiun Shimokitazawa (下北沢駅)</strong>, keluar melalui Gerbang Tengah (中央口), berjalan kaki sekitar 3 menit.</p>
                    </div>
                </div>
            </section>
        ...
        <div class="md:col-span-4 space-y-6">
            ...
            <div class="bg-white border border-slate-200 rounded-lg p-5 shadow-sm space-y-3 text-xs">
                <h3 class="font-bold text-slate-900 text-xs uppercase tracking-wider pb-2 border-b border-slate-200">
                    Jam Kerja Tata Usaha (窓口受付)
                </h3>
                <div class="space-y-1.5 text-[11px] text-slate-600">
                    <div><strong>Senin - Jumat:</strong> 08:30 - 17:00 JST</div>
                    <div><strong>Sabtu:</strong> 08:30 - 13:00 JST</div>
                    <div><strong>Minggu & Hari Libur:</strong> Tutup (休館日)</div>
                </div>
            </div>
